...
Insert into stocks(id,name,category,price,imgsrc) values ('main1_1','Blooming Notebook','Notebook','$20.00','/img/main/bestseller/main1_1.JPG');
Insert into stocks(id,name,category,price,imgsrc) values ('main1_2','Overthinker Notebook','Notebook','$20.50','/img/main/bestseller/main1_2.JPG');
Insert into stocks(id,name,category,price,imgsrc) values ('main1_3','Friendship Notebook','Notebook','$9.00','/img/main/bestseller/main1_3.JPG');
Insert into stocks(id,name,category,price,imgsrc) values ('main1_4','School Notebook','Notebook','$8.00','/img/main/bestseller/main1_4.JPG');
Insert into stocks(id,name,category,price,imgsrc) values ('main1_Test1','TSchool Notebook','Notebook','$8.00','/img/main/bestseller/main1_4.JPG');


Insert into stocks(id,name,category,price,imgsrc) values ('main2_1','Oh Baby Cards','Greeting Cards','$3.00','/img/main/bestseller/main2_1.JPG');
Insert into stocks(id,name,category,price,imgsrc) values ('main2_2','Birthday Love','Greeting Cards','$3.00','/img/main/bestseller/main2_2.JPG');
